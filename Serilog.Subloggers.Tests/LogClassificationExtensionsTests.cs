...
{
    [TestClass]
    public class LogClassificationExtensionsTests
    {
        [TestMethod]
        public void Write_Debug()
        {
            ...
            log.System().Write(LogLevel.Debug, "test");
        ...
        public void Write_Info()
        {
            var instance = LoggerContext.TestFactory();
            Microsoft.Extensions.Logging.ILogger log = instance;
            log.System().Write(LogLevel.Information, "test");
        ...
        public void Write_Warning()
        {
            var instance = LoggerContext.TestFactory();
            Microsoft.Extensions.Logging.ILogger log = instance;
            log.System().Write(LogLevel.Warning, "test");
        ...
        public void Write_Critical()
        {
            var instance = LoggerContext.TestFactory();
            Microsoft.Extensions.Logging.ILogger log = instance;
            log.System().Write(LogLevel.Critical, "test");
        ...
        public void Write_Error()
        {
            var instance = LoggerContext.TestFactory();
            Microsoft.Extensions.Logging.ILogger log = instance;
            log.System().Write(LogLevel.Error, "test");
        ...
        public void Write_Trace()
        {
            var instance = LoggerContext.TestFactory();
            Microsoft.Extensions.Logging.ILogger log = instance;
            log.System().Write(LogLevel.Trace, "test");
        ...
        public void Write_Debug_Params()
        {
            var instance = LoggerContext.TestFactory();
            Microsoft.Extensions.Logging.ILogger log = instance;
            log.System().Write(LogLevel.Debug, "test {0}", "param");
        ...
        public void Write_Info_Params()
        {
            var instance = LoggerContext.TestFactory();
            Microsoft.Extensions.Logging.ILogger log = instance;
            log.System().Write(LogLevel.Information, "test {0}", "param");
        ...
        public void Write_Warning_Params()
        {
            var instance = LoggerContext.TestFactory();
            Microsoft.Extensions.Logging.ILogger log = instance;
            log.System().Write(LogLevel.Warning, "test {0}", "param");
        ...
        public void Write_Critical_Params()
        {
            var instance = LoggerContext.TestFactory();
            Microsoft.Extensions.Logging.ILogger log = instance;
            log.System().Write(LogLevel.Critical, "test {0}", "param");
        ...
        public void Write_Error_Params()
        {
            var instance = LoggerContext.TestFactory();
            Microsoft.Extensions.Logging.ILogger log = instance;
            log.System().Write(LogLevel.Error, "test {0}", "param");
        ...
        public void Write_Trace_Params()
        {
            var instance = LoggerContext.TestFactory();
            Microsoft.Extensions.Logging.ILogger log = instance;
            log.System().Write(LogLevel.Trace, "test {0}", "param");
        ...
        public void Write_Exception_Params()
        {
            var instance = LoggerContext.TestFactory();
            Microsoft.Extensions.Logging.ILogger log = instance;
            log.System().Write(LogLevel.Trace, new Exception("WriteEx"), "test {0}", "write");
        ...
        public void Write_Exception()
        {
            var instance = LoggerContext.TestFactory();
            Microsoft.Extensions.Logging.ILogger log = instance;
            log.System().Write(LogLevel.Trace, new Exception("WriteEx"), "test write");
            instance.AssertContainsException(LogLevel.Trace, "test write", "WriteEx");
        }
        ...
        public void Verbose_Exception()
        {
            var instance = LoggerContext.TestFactory();
            Microsoft.Extensions.Logging.ILogger log = instance;
            log.System().Verbose(new Exception("VerboseEx"), "test");
        ...
        public void Verbose_Exception_Params()
        {
            var instance = LoggerContext.TestFactory();
            Microsoft.Extensions.Logging.ILogger log = instance;
            log.System().Verbose(new Exception("VerboseEx"), "{0}", "param");
        ...
        public void Info_Exception()
        {
            var instance = LoggerContext.TestFactory();
            Microsoft.Extensions.Logging.ILogger log = instance;
            log.System().Info(new Exception("InfoEx"), "test");
        ...
        public void Info_Exception_Params()
        {
            var instance = LoggerContext.TestFactory();
            Microsoft.Extensions.Logging.ILogger log = instance;
            log.System().Info(new Exception("InfoEx"), "test {0}", "param");
        ...
        public void Debug_Exception()
        {
            var instance = LoggerContext.TestFactory();
            Microsoft.Extensions.Logging.ILogger log = instance;
            log.System().Debug(new Exception("DebugEx"), "test Debug");
        ...
        public void Debug_Exception_Params()
        {
            var instance = LoggerContext.TestFactory();
            Microsoft.Extensions.Logging.ILogger log = instance;
            log.System().Debug(new Exception("DebugEx"), "{0}", "Debug");
        ...
        public void Information()
        {
            var instance = LoggerContext.TestFactory();
            Microsoft.Extensions.Logging.ILogger log = instance;
            log.System().Information("test Information");
        ...
        public void Information_Params()
        {
            var instance = LoggerContext.TestFactory();
            Microsoft.Extensions.Logging.ILogger log = instance;
            log.System().Information("{0}", "Information");
        ...
        public void Information_Exception()
        {
            var instance = LoggerContext.TestFactory();
            Microsoft.Extensions.Logging.ILogger log = instance;
            log.System().Information(new Exception("InformationEx"), "test Information");
        ...
        public void Information_Exception_Params()
        {
            var instance = LoggerContext.TestFactory();
            Microsoft.Extensions.Logging.ILogger log = instance;
            log.System().Information(new Exception("InformationEx"), "{0}", "Information");
        ...
        public void Warning()
        {
            var instance = LoggerContext.TestFactory();
            Microsoft.Extensions.Logging.ILogger log = instance;
            log.System().Warning("test Warning");
        ...
        public void Warning_Exception()
        {
            var instance = LoggerContext.TestFactory();
            Microsoft.Extensions.Logging.ILogger log = instance;
            log.System().Warning(new Exception("WarningEx"), "test Warning");
        ...
        public void Warning_Exception_Params()
        {
            var instance = LoggerContext.TestFactory();
            Microsoft.Extensions.Logging.ILogger log = instance;
            log.System().Warning(new Exception("WarningEx"), "{0}", "Warning");
        ...
        public void Error_Exception()
        {
            var instance = LoggerContext.TestFactory();
            Microsoft.Extensions.Logging.ILogger log = instance;
            log.System().Error(new Exception("ErrorEx"), "test Error");
        ...
        public void Error_Exception_Params()
        {
            var instance = LoggerContext.TestFactory();
            Microsoft.Extensions.Logging.ILogger log = instance;
            log.System().Error(new Exception("ErrorEx"), "{0}", "Error");
        ...
        public void Fatal_Exception()
        {
            var instance = LoggerContext.TestFactory();
            Microsoft.Extensions.Logging.ILogger log = instance;
            log.System().Fatal(new Exception("FatalEx"), "test Fatal");
        ...
        public void Fatal_Exception_Params()
        {
            var instance = LoggerContext.TestFactory();
            Microsoft.Extensions.Logging.ILogger log = instance;
            log.System().Fatal(new Exception("FatalEx"), "{0}", "Fatal");
